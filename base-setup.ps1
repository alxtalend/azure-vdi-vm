...
Start-Process -FilePath "ChromeStandaloneSetup64.exe" -Verb runAs -ArgumentList '/silent','/install'
...
Start-Process -FilePath "msiexec.exe" -Verb runAs -ArgumentList '/i slack-standalone-4.4.0.0.msi','/qn','/norestart'
...
Start-Process -FilePath "msiexec.exe" -Verb runAs -ArgumentList '/i ZoomInstallerFull.msi','/qn','/norestart','/quiet','ZSILENTSTART="true"'
...
Start-Process -FilePath "msiexec.exe" -Verb runAs -ArgumentList '/i ZoomOutlookPluginSetup.msi','/qn','/norestart','/quiet'
